...
<nav class="navbar  navbar-expand-md   sticky-top p-0 ">
    ...
    <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
        <h1 class="display-3 text-white animated slideInDown">Other Requirements</h1>
    </div>
    <br>
    <center><P><b><h2 style="color: darkred;"> <u>PLEASE TAKE NOTE:</u></h2></b></p></center>
    <!-- start modern cards -->

    <div class="container-1">
        <div class="itemz">
            <div class="layer">
                <h3 class="h3" style="color: blue;">SCHOOL REQUIREMENTS</h3>
                <p class="p2">
                    1. Photocopy of UCE result slip.<br>
                    2. Five (5) recent passport photos.<br>
                    3. Two (2) recent passport photos of parent/guardian.<br>
                    4. Birth Certificate for the student.
                </p>
            </div>
            <h4 class="h9">Note</h4>
        </div>
        ...
        <div class="itemz">
            <div class="layer">
                <h3 class="h3" style="color: blue;">SCHOOL UNIFORM</h3>
                <p class="p2">
                    1. Uniforms will be paid and obtained from school.
                </p>
            </div>
            <h4 class="h9">Note</h4>
        </div>
        ...
        <div class="itemz">
            <div class="layer">
                <h3 class="h3" style="color: blue;">SCHOOL FEES</h3>
                <p class="p2">
                    1. School fees MUST be paid using Student'sPay Code in Centenary Bank.
                </p>
            </div>
            <h4 class="h9">Note</h4>
        </div>
  ...
  <center>
   ...
   <div class="arrow-container">
    <a href="./apply.php" class="arrow back">
      &#8592; <!-- Left Arrow -->
    </a>
    <a href="./Fees.php" class="arrow next">
      &#8594; <!-- Right Arrow -->
