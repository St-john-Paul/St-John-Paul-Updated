    ...
    <div class="both " style="border-top: 5px solid orange; background-color: rgb(255, 255, 255);">
     ...
     <!-- Navbar End -->
        ...
        <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
            <h1 class="display-3 text-white animated slideInDown">O-level Subjects </h1>
        </div>
        <br>
    <!-- Header End -->
  ...
  <div class="table-responsive">
    ...
    <!--End Table-->
      ...
      <div class="arrow-container">
        ...
        <a href="about.php" class="arrow next">
          &#8594; <!-- Right Arrow -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="mb-5" style="color: darkred;"><u>Vocational Courses</u></h1>
            </div>
...
<div class="arrow-container">
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                <h1 class="mb-5" style="color: darkred;"><u> Parents Voice</u></h1>
            </div>
    ...
    <div class="arrow-container">
        <a href="./Mission&Vision.php" class="arrow back">
          &#8592; <!-- Left Arrow -->
        </a>
