...
<html>
<head>
  <title>St. John Paul II Vocational Training Centre FAQ</title>
...
<!-- <div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
  ...
  <div class="faq-container">
    <h2>St. John Paul II Vocational Training Centre FAQ</h2>
    
    <div class="faq-item">
      <div class="faq-question">What are the objectives of the school?</div>
      <div class="faq-answer">
        <p class="foxk">The school's objectives are to:</p>
        <ul>
          <li class="foxk">Provide high-quality, affordable education for all Ugandans</li>
          <li class="foxk">Provide a suitable, conducive learning environment</li>
          <li class="foxk">Tap into and nurture students' talents</li>
          <li class="foxk">Provide vocational skills</li>
          <li class="foxk">Instill self-discipline, responsibility, and harmonious co-existence</li>
          <li class="foxk">Produce morally upright, God-fearing citizens</li>
        </ul>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What is the school's mission?</div>
      <div class="faq-answer">
        <p class="foxk">The school's mission is to be a leading institution providing holistic, all-around education by nurturing students' intellectual competencies, discovering talents, and bringing up creative citizens with a moral sense of social responsibility.</p>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What are the school's core values?</div>
      <div class="faq-answer">
        <p class="foxk">The school's core values are:</p>
        <ul>
          <li class="foxk">Teamwork</li>
          <li class="foxk">Customer care orientation</li>
          <li class="foxk">Value addition</li>
          <li class="foxk">Result orientation</li>
          <li class="foxk">Creativity</li>
          <li class="foxk">Integrity</li>
          <li class="foxk">Discipline</li>
          <li class="foxk">God-fearing</li>
        </ul>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What is the school's vision?</div>
      <div class="faq-answer">
        <p class="foxk">The school's vision is to provide a holistic, all-round education for the highest value.</p>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What subjects are offered at O-Level?</div>
      <div class="faq-answer">
        <p class="foxk">O-Level subjects include:</p>
        <ul>
          <li class="foxk">Mathematics</li>
          <li class="foxk">English</li>
          <li class="foxk">Chemistry</li>
          <li class="foxk">Physics</li>
          <li class="foxk">Biology</li>
          <li class="foxk">Agriculture</li>
          <li class="foxk">History</li>
          <li class="foxk">Geography</li>
          <li class="foxk">Entrepreneurship</li>
          <li class="foxk">Luganda</li>
          <li class="foxk">Kiswahili</li>
          <li class="foxk">Computer</li>
          <li class="foxk">Literature</li>
          <li class="foxk">Fine Art</li>
          <li class="foxk">CRE/IRE</li>
        </ul>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What subjects are offered at A-Level?</div>
      <div class="faq-answer">
        <p class="foxk">A-Level subjects include:</p>
        <ul>
          <li class="foxk">Mathematics</li>
          <li class="foxk">English</li>
          <li class="foxk">Chemistry</li>
    ...
    <div class="faq-item">
      <div class="faq-question">What vocational skills are taught?</div>
      <div class="faq-answer">
        <p class="foxk">Students are trained in practical skills such as:</p>
        <ul>
          <li class="foxk">Hairdressing</li>
          <li class="foxk">Tailoring</li>
          <li class="foxk">Computer skills</li>
          <li class="foxk">Mechanics</li>
          <li class="foxk">Building and construction</li>
          <li class="foxk">Electronic wiring and repairs</li>
        </ul>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What co-curricular activities are available?</div>
      <div class="faq-answer">
        <p class="foxk">Students are encouraged to participate in a wide range of co-curricular activities like:</p>
        <ul>
          <li class="foxk">MDD (Music, Dance and Drama)</li>
          <li class="foxk">Sports</li>
        </ul>
        <p class="foxk">The school provides well-maintained indoor and outdoor facilities.</p>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">Are the school fees affordable?</div>
      <div class="faq-answer">
        <p class="foxk">The school fees are affordable and negotiable. Bursaries are offered to bright students who excel in PLE and UCE.</p>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What clubs are available?</div>
      <div class="faq-answer">
        <p class="foxk">The school has the following clubs:</p>
        <ul>
          <li class="foxk">Debate Club</li>
          <li class="foxk">Interact Club</li>
          <li class="foxk">Patriotism Club</li>
          <li class="foxk">Scripture Union</li>
        </ul>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">Where is the school located?</div>
      <div class="faq-answer">
        <p class="foxk">The school is located 1.5km off the Mukono-Mbalala Stage on the Kampala Jinja Highway, on the road to Seeta College School in Wankoba Parish, Nakisunga Subcounty, Mukono District.</p>
      </div>
    </div>
    
    <div class="faq-item">
      <div class="faq-question">What curriculum is followed?</div>
      <div class="faq-answer">
        <p class="foxk">The school has integrated the New National Secondary Curriculum and vocational subjects to equip students with life skills.</p>
      </div>
    </div>
  ...
  <center>
    <button class="buttonz" type="button">
      <strong><a href="./404_page.php" style="color: whitesmoke;">MORE</a></strong>
