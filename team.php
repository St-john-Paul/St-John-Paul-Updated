    ...
    <div class="both " style="border-top: 5px solid orange; background-color: rgb(255, 255, 255);">
        ...
        <div class="container-fluid pt-1 pb-1" style="background-color:rgb(248, 215, 155);">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav nav-pills w-100" style=" background-color:rgb(248, 215, 155); justify-content: center;display: flex; padding-top: 5px;">
              ...
              <li class="nav-item">
                <a class="nav-link" href="./team.php" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; border-radius: 10px; margin-left: 5px; background-color: darkred;">Team</a>
              </li>
              <li class="nav-item">
     ...
     <!-- Navbar End -->
        ...
        <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
            <h1 class="display-3 text-white animated slideInDown">Staff Members</h1>
        </div>
        <br>
    <!-- Header End -->
...
<div class="prof">
    ...
    <div class="card "  style="margin-top: 12px;">
        <div class="card-image">
            <img src="./img/st john/trs/bursar.JPG" alt="Profile image">
        </div>
        <p class="name">Ms. Nakizito Daisy</p>
        <small class="fox">Bursar</small>
