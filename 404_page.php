...
<div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
  ...
  <div class="end-404">
    <div class="content">
      ...
      <p class="fog">I tried to catch some fog, but i mist</p>
      <!--BUTTON-->
    <center>
      <button class="buttonz" type="button">
        <strong><a href="./index.php" style="color: whitesmoke;">BACK TO HOME</a></strong>
    ...
    <img src="./img/15.JPG" class="img-cover"/>
  </div>
    <!--End 404 Page-->
    <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    <div class="arrow-container">
        <a href="./FAQs.php" class="arrow back">
          &#8592; <!-- Left Arrow -->
        </a>
        <a href="index.php" class="arrow next">
          &#8594; <!-- Right Arrow -->
        </a>
      </div>
      <br>
