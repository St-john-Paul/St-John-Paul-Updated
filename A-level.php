...
<!-- <div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
        <h1 class="display-3 text-white animated slideInDown">A-level Adimission</h1>
    </div>
    <br>
    <!-- Header End -->
<br>
...
<center><P><b><h1  style="color: darkred;">ST. JOHN PAUL II VOC & HIGH SCH MBALALA-MUKONO. </h1></b></p></center>
    <center><P><b><h2 style="color: orange;"> A’ LEVEL - SCHOOL REQUIREMENTS</h2></b></p></center>
        <center>
            <ol>
     <li class="fox">Photocopy of UCE result slip.</li>
     <li class="fox">Five (5) recent passport photos (black and white or colour)<br>
          or can be taken from school at Ushs.5,000 (Five thousand shillings).</li>
     <li class="fox">Two (2) recent passport photos of parent/guardian.</li>
     <li class="fox">One (1) ream of photocopying papers (DIGITAL / IQ  / TOP-COPIER).</li>
              </ol> 
         </center>
         <center>
...
<div class="arrow-container">
    <a href="./A-level-courses.php" class="arrow back">
      &#8592; <!-- Left Arrow -->
    </a>
    <a href="./apply.php" class="arrow next">
      &#8594; <!-- Right Arrow -->
