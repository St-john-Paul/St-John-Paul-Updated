...
<body>
   ...
   <!-- <div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid pt-1 pb-1" style="background-color:rgb(248, 215, 155);">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav nav-pills w-100" style=" background-color:rgb(248, 215, 155); justify-content: center;display: flex; padding-top: 5px;">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; border-radius: 10px; margin-left: 5px; background-color: darkred;">Mission</a>
    ...
    <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
        <h1 class="display-3 text-white animated slideInDown">Our Mission and Vision</h1>
    </div>
    <br>
    <!-- Header End -->
        ...
        <div class="container">
            <div class="row">
              <div class="col align-self-start">
                <h3 style="color: darkred;"><b>Objectives</b></h3>
                <ul style="list-style: none; text-align: left;">
                  <li class="fox">To provide high-quality education which is affordable to all Ugandans.</li>
                  <li class="fox">To provide a suitable and conducive environment for learning.</li>
                  <li class="fox">To tap and nurture talents.</li>
                  <li class="fox">To provide students with Vocational Skills.</li>
                  <li class="fox">To instill a sense of self-discipline, responsibility, and harmonious co-existence.</li>
                  <li class="fox">To produce morally upright God-fearing citizens.</li>
                </ul>
              </div>
              <div class="col align-self-center">
                <h3 style="color: darkred;"><b>Mission</b></h3>
                <p class="fox" style="text-align: left;">To be a leading institution in providing a holistic all-around<br> education by nurturing students'
                ...
                <h3 style="color: darkred;"><b>Vision</b></h3>
                <p class="fox" style="text-align: left;">To provide a holistic all-round education for the Highest Value.</p>
              </div>
              <div class="col align-self-end">
                <h3 style="color: darkred;"><b>Core Values</b></h3>
                <ul style="list-style: none; text-align: left;">
                  <li class="fox">Team Work</li>
                  <li class="fox">Customer care orientedness</li>
                  <li class="fox">Value Addition</li>
                  <li class="fox">Result Oriented</li>
                  <li class="fox">Creativity</li>
                  <li class="fox">Integrity</li>
                  <li class="fox">Discipline</li>
                  <li class="fox">God Fearing</li>
                </ul>
              </div>
            </div>
          </div>
...
<center>
    <button class="buttonz" type="button">
      <strong><a href="./about.php" style="color: whitesmoke;">MORE</a></strong>
  ...
  <div class="arrow-container">
    <a href="./about.php" class="arrow back">
      &#8592; <!-- Left Arrow -->
    </a>
    <a href="./courses.php" class="arrow next">
      &#8594; <!-- Right Arrow -->
