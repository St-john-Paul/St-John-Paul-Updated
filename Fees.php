...
<body>
   ...
   <!-- <div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <!-- Header End -->
        ...
        <center><P><b><h2 style="color: blue;"> SCHOOL FEES STRUCTURE.</h2></b></p></center>
            <center>
                <h5><b>0-LEVEL</b></h5>
...
<br>
<center><P><b><h2 style="color: blue;"> A-LEVEL.</h2></b></p></center>
<center>  
...
<br>
<center><P><b><h2 style="color: blue;"> VOCATIONAL REQUIREMENTS</h2></b></p></center>
    <center>
        ...
        <tr>
            ...
            <td class="fox"> 350,000/=</td>
        </tr>
        <tr>
            <td class="fox"> Hair Dressing & Cosmetology.</td>
            <td class="fox"> 250,000/=</td>
           </tr>
           <tr>
           ...
           <tr>
            <td class="fox">Agriculture</td>
            <td class="fox"> 250,000/=</td>
           </tr>
           <tr>
            <td class="fox">Entrepreneurship</td>
            <td class="fox"> 250,000/=</td>
           </tr>
    </table>
    </center>
<br>
    <center><P><b><h2 style="color: blue;">FUNCTIONAL FEES</h2></b></P></center>
    <center>
        <p style="font-weight: bolder;">Covers the following items:</p>
<table border="2" width="50%" height="50%" cellpadding="10" cellspacing="10">
    <tr>
        <th bgcolor="darkred" style="color: whitesmoke;" class="fox">Items</th>
        <th bgcolor="darkred" style="color: whitesmoke;" class="fox">Amount(UGX.)</th>
    ...
    <tr>
        <td class="fox">Boarding scholars</td>
        <td class="fox"> 750,000/=</td>
    </tr>
    <tr>
        <td class="fox"> ID</td>
        <td class="fox"> 10,000/=</td>
    </tr>
    <tr>
        <td class="fox"> Uniform</td>
        <td class="fox"> 250,000/=</td>
    </tr>
