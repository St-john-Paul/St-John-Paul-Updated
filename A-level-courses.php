...
<head>
    ...
    <style>
        ...
        th, td {
            padding: 15px; /* Adds space inside each cell */
...
<style>
    ...
    .table-responsive thead th {
        font-size: 18px; /* Adjust font size for header if needed */
    }
...
<!-- <div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="both " style="border-top: 5px solid orange; background-color: rgb(255, 255, 255);">
        ...
        <div class="container-fluid pt-1 pb-1" style="background-color:rgb(248, 215, 155);">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav nav-pills w-100" style=" background-color:rgb(248, 215, 155); justify-content: center;display: flex; padding-top: 5px;">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; border-radius: 10px; margin-left: 5px; background-color: darkred;">Subjects</a>
                <ul class="dropdown-menu">
     ...
     <!-- Navbar End -->
        ...
        <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
            <h1 class="display-3 text-white animated slideInDown">A-level Subjects Offered</h1>
        </div>
        <br>
    <!-- Header End -->
    ...
    <!-- Categories Start -->
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 2px;">
        <h1 class="mb-5" style="color: darkred;">Subject Categories</h1>
    </div>

<!-- Categories Start -->
<div class="card-group" style=" margin-top: 2px;">
<div class="card" style="height: 520px; margin-top: 1px;">
  <img src="./img/st john/experiments/15.JPG" style="height: 370px;"  class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Core Subjects</h5>
  </div>
  <div class="card-footer">
    <a href="./courses.php"><small class="fox" style="color:  rgb(111, 111, 242);">4 Subjects</small></a>
  </div>
</div>
<div class="card" style="height: 520px; margin-top: 1px;">
  <img src="./img/st john/experiments/17.JPG"  style="height: 370px;"  class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Humanities & Social Sciences</h5>
  </div>
  <div class="card-footer">
    <a href="./courses.php"><small class="fox" style="color:  rgb(111, 111, 242);">6 Subjects</small></a>
  </div>
</div>
<div class="card" style="height: 520px; margin-top: 1px;">
    <img src="./img/st john/experiments/20.JPG" style="height: 370px;"  class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Languages</h5>
    </div>
    <div class="card-footer">
      <a href="./courses.php"><small class="fox" style="color:  rgb(111, 111, 242);">3 Subjects</small></a>
    </div>
  </div>
<div class="card" style="height: 520px; margin-top: 1px;">
  <img src="./img/st john/experiments/4.JPG" style="height: 370px;"  class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Entrepreneurship & Applied Sciences</h5>
  </div>
  <div class="card-footer">
    <a href="./courses.php"><small class="fox" style="color:  rgb(111, 111, 242);">2 Subjects</small></a>
  </div>
</div>
</div>
 ...
 <br>
  ...
  <div class="table-responsive">
    <table border="2" cellpadding="10" cellspacing="10">
        <thead>
            <tr>
                <th class="core" style="font-size: 25px;">Core Subjects</th>
                <th class="core" style="font-size: 25px;">Humanities and Social Sciences</th>
                <th class="core" style="font-size: 25px;">Applied Sciences</th>
                <th class="core" style="font-size: 25px;">Entrepreneurship</th>
                <th class="core" style="font-size: 25px;">Languages</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="font-size: 20px;">Mathematics</td>
                <td style="font-size: 20px;">Biology</td>
                <td style="font-size: 20px;">Agriculture</td>
                <td style="font-size: 20px;">Entrepreneurship</td>
                <td style="font-size: 20px;">Luganda</td>
            </tr>
            <tr>
                <td style="font-size: 20px;">English</td> 
                <td style="font-size: 20px;">History</td>
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;">Kiswahili</td>
            </tr>
            <tr>
                <td style="font-size: 20px;">Chemistry</td>
                <td style="font-size: 20px;">Geography</td>
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;">Computer</td>
            </tr>
            <tr>
                <td style="font-size: 20px;">Physics</td>
                <td style="font-size: 20px;">Literature</td> 
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
            </tr>
            <tr>
                <td></td>
                <td style="font-size: 20px;">Fine Art</td>
                <td style="font-size: 20px;"></td> 
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
            </tr>
            <tr>
                <td></td>
                <td style="font-size: 20px;">CRE/IRE</td> 
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
                <td style="font-size: 20px;"></td>
            </tr>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5" style="color: darkred;">Popular Courses</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/st john/vocation/B1.jpg" alt="">
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                ...
                                <a href="./Admission.php" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                            </div>
                        </div>
                        <div class="text-center p-4 pb-0">
                            <h5 class="mb-4">Building And Construction</h5>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/st john/vocation/t8.JPG" alt="">
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                <a href="./about.php" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                                <a href="./Admission.php" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/st john/vocation/h4.JPG" alt="">
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                <a href="./about.php" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                                <a href="./Admission.php" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                            </div>
                        ...
                        <div class="text-center p-4 pb-0">
                            <h5 class="mb-4">Hair Dressing</h5>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="table-responsive" >
    <table border="2" cellpadding="10" cellspacing="10">
        <thead>
            <tr>
                <th class="core" colspan="6" style="font-size: 25px;">Vocational Courses</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="font-size: 20px;">Mechanical Engineering</td>
                <td style="font-size: 20px;">Hair Dressing</td>
                <td style="font-size: 20px;">Tailoring</td>
                <td style="font-size: 20px;">Computer Studies</td>
                <td style="font-size: 20px;">Building & Construction</td>
                <td style="font-size: 20px;">Electronic Wiring & Repairs</td>
            </tr>
        </tbody>
    </table>
</div>
<!--End Table-->
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                ...
                <h1 class="mb-5" style="color: darkred;">Our Parents Say!</h1>
            </div>
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="./img/st john/avator.jpeg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0"style="color: orange;">Kato Joseph</h5>
                    <p class="fox">Parent</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0" style="font-weight: bold;">The sense of community at St. John Paul II Vocational and High School is unparalleled. From the engaging curriculum to the extracurricular activities, my child has received a well-rounded education that has prepared them for future success.
                         The school's emphasis on values and character building is truly commendable.</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="./img/st john/avator.jpeg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0" style="color: orange;">Henry Bukomeko</h5>
                    <p class="fox">Parent</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0" style="font-weight: bold;">St. John Paul II Vocational and High School provides an exceptional learning environment. 
                        The dedicated teachers and diverse programs ensure that each student can excel academically and develop essential life skills. My child has flourished here, and I am grateful for the school's commitment to excellence.</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="./img/st john/avator.jpeg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0" style="color: orange;">Sarah Mbabazi</h5>
                    <p class="fox">Parent</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0" style="font-weight: bold;">Enrolling my child at St. John Paul II Vocational and High School has been one of the best decisions I've made. The school's holistic approach to education, focusing on both academic and personal development, has helped my child grow into a confident and well-rounded individual.
                         The supportive staff and nurturing environment make it a truly special place.</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="./img/st john/avator.jpeg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0" style="color: orange;">Peter Mukasa</h5>
                    <p class="fox">Parent</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0" style="font-weight: bold;">Choosing St. John Paul II Vocational and High School for my child's education has been a wonderful experience. The school's focus on academic rigor, combined with a supportive and inclusive environment, has helped my child achieve their full potential.
                         I highly recommend this school to any parent seeking a quality education for their child.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="arrow-container">
        <a href="./courses.php" class="arrow back">
          &#8592; <!-- Left Arrow -->
        </a>
        <a href="./A-level-courses.php" class="arrow next">
          &#8594; <!-- Right Arrow -->
        </a>
      </div>
      <br>
