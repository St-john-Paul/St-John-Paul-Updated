    ...
    <div class="both " style="border-top: 5px solid orange; background-color: rgb(255, 255, 255);">
            ...
            <div class="container-fluid pt-1 pb-1" style="background-color:rgb(248, 215, 155);">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav nav-pills w-100" style=" background-color:rgb(248, 215, 155); justify-content: center;display: flex; padding-top: 5px;">
                  ...
                  <li class="nav-item dropdown">
                    <a href="#" id="Admission" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; border-radius: 10px; margin-left: 5px; background-color: darkred;">Admission</a>
                    <ul class="dropdown-menu fade-down m-0">
     ...
     <!-- Navbar End -->
        ...
        <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
            <h1 class="display-3 text-white animated slideInDown">Vocational Admission</h1>
        </div>
        <br>
    <!-- Header End -->
<br>
  
<center><P><b><h1  style="color: darkred;">ST. JOHN PAUL II VOC & HIGH SCH MBALALA-MUKONO. </h1></b></p></center>
    <center><P><b><h2 style="color: orange;"> VOCATIONAL ADMISSION</h2></b></p></center>
        <center>
            <h5><b>SCHOOL FEES:</b></h5>
            <p style="font-weight: bold;">School fees covers the following items:</p>
    <table border="2" width="50%" height="50%" cellpadding="10" cellspacing="10">
        <tr>
            <th bgcolor="darkred" style="color: whitesmoke;" class="fox">Items</th>
            <th bgcolor="darkred" style="color: whitesmoke;" class="fox">Amount(UGX.)</th>
        <tr>
            <td class="fox">Admission Fee </td>
            <td class="fox">50,000/= </td>
        </tr>
        <tr>
            <td class="fox">Medical Fee </td>
            <td class="fox"> 50,000</td>
        </tr> 
        <tr>
            <td class="fox">Development Fee </td>
            <td class="fox"> 50,0000</td>
        </tr> 
        <tr>
            <td class="fox">Day Scholars</td>
            <td class="fox"> 450,0000</td>
        </tr>
        <tr>
            <td class="fox">Boarding scholars</td>
            <td class="fox"> 650,000</td>
        </tr>
        <tr>
            <td class="fox"> ID</td>
            <td class="fox"> 5,000</td>
        </tr>
        
    </table>
</center>
<center>
    <table border="2" width="70%" height="50%" cellpadding="10" cellspacing="10">
    <tr>
        <th bgcolor="darkred" style="color: whitesmoke; height: 50px;" class="fox">VOCATIONAL PROGRAMMES</th>
       <th bgcolor="darkred" style="color: whitesmoke; height: 50px;" class="fox">
      Fees per Term (USH)
         </th>
    <tr>
        <td class="fox">Mecahnical Engineering</td>
        <td class="fox"> 450,000/=</td>
    </tr>
    <tr>
        <td class="fox"> Hair Dressing & Cosmetology.</td>
        <td class="fox"> ******</td>
       </tr>
       <tr>
        <td class="fox">Tailoring</td>
        <td class="fox"> ******</td>
       </tr>
       <tr>
        <td class="fox">Computer Studies</td>
        <td class="fox"> ******</td>
       </tr>
       <tr>
        <td class="fox">Electronic Wiring & Repairs</td>
        <td class="fox"> ******</td>
       </tr>
       <tr>
        <td class="fox">Building & Construction</td>
        <td class="fox"> ******</td>
       </tr>
</table>
</center>
<center> <h5 style="font-size: 20px; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">NB: All students offering vocational subjects should come with their<br> learning materials for practical session.</h5></center>
<br>
<center>
    <button class="buttonz" type="button">
      <strong><a href="./apply.php" style="color: whitesmoke;">MORE</a></strong>
  ...
  <div class="arrow-container" style="margin-bottom: 0px;">
    <a href="./contact.php" class="arrow back">
      &#8592; <!-- Left Arrow -->
    </a>
