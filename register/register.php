        ...
        <div class="container">
            ...
            <div class="workinghny-form-grid" style="background-color:  #4d0000;">
                <div class="main-mockup">
                    ...
                    <div class="w3l_form align-self" style="background-image: url('./images/26.jpg'); background-size: cover; background-repeat: no-repeat; border: 2px solid gray; background-color: #F0F8FF;">
</div>
                    <div class="content-wthree">
                        <h2  style="color: blue;">Register Now</h2>
                        ...
                        <form action="" method="post">
                            ...
                            <section class="w3l-mockup-form" style="background-color:  #4d0000;">Register</button>
                        </form>
