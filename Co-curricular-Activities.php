...
<body>
    ...
    <div class="col-lg-10 text-center" style=" width: inherit; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
        <h1 class="display-3 text-white animated slideInDown">Co-curricular Activities</h1>
    </div>
    <br>
    <!-- Header End -->


    <h3  style="color: blue;" ><b style="margin-left: 120px;">Exploring the Vibrant Co-Curricular Scene at </b></h3>
    <h3  style="color: blue;" ><b style="margin-left: 120px;">St. John Paul II Vocational & High Sch Mbalala-Mukono.</b></h3>
    <br>
    <div class="top-curricular" style="border-bottom: 1px solid whitesmoke;">
       <p class="fox6" style="margin-left: 120px;"> St. John Paul II Vocational & High Sch Mbalala-Mukono, a renowned educational institution,<br>
         takes great pride in offering a diverse range of co-curricular activities for its students. </p>
       <p class="fox6" style="margin-left: 120px;"> These activities not only enrich the educational experience but also help in the holistic<br>
         development of the students. At St. John Paul II Vocational & High Sch Mbalala-Mukono, students <br>
         have the opportunity to participate in various sports, clubs, and societies, fostering their talents,<br>
          interests, and teamwork skills.</p>
    </div>
    <br>
    <div>
        <h3 style="color: blue; font-weight: bold; margin-left: 120px;"><u><b>Sports at St. John Paul II Vocational & High Sch Mbalala-Mukono:</b></u></h3>
        <ul style="list-style: none;">
            <li class="fox" style="color:black; margin-left: 120px;"><b>1. Handball: </b><br>The school's handball team is a force to be reckoned with in local competitions. <br>
            Students are encouraged to join and develop their handball skills, promoting physical fitness and teamwork.</li>
            <br>
        <li class="fox" style="color:black; margin-left: 120px;"><b>3. Football:</b><br> Football is a beloved sport at the school, with both boys and girls teams.
        <br> Students can kick-start their football dreams and showcase their athletic abilities.</li>
        <br>
        <li class="fox" style="color:black; margin-left: 120px;"><b>4. Chess:</b><br> For those with a strategic mind, the school offers a competitive chess club.Chess enthusiasts<br>
             can engage in tactical battles, honing their problem-solving skills.</li>
             <br>
        <li class="fox" style="color:black; margin-left: 120px;"><b>5. Basketball:</b><br> The basketball team at St. John Paul II Vocational & High Sch Mbalala-Mukono competes at a high level.</li>
        <br>
        </ul>
        <p class="fox" style="color:black; margin-left: 120px;"> Students with a passion for hoops can join and work on their dribbling, shooting, and teamwork.</p>
    </div>
   
    <div >
       <p class="fox" style="color:black; margin-left: 120px;">St. John Paul II Vocational & High Sch Mbalala-Mukono’s commitment to providing a wide array of co-curricular <br>
        activities underscores its dedication to nurturing well-rounded individuals. These activities not only promote<br>
         physical fitness but also help students discover and develop their talents and interests. </p>
        <p class="fox" style="color:black; margin-left: 120px;">Through sports and clubs, St. John Paul II Vocational & High Sch Mbalala-Mukono continues to inspire its<br>
         students to reach for their full potential, both inside and outside the classroom.</p>
    </div>


   
  <!--Co-curricular Activities End-->

     <!--BUTTON-->
     <center>
        <button class="buttonz" type="button">
          <strong><a href="./contact.php" style="color: whitesmoke;">MORE</a></strong>
      ...
      <div class="arrow-container">
        <a href="./Clubs.php" class="arrow back">
          &#8592; <!-- Left Arrow -->
        </a>
