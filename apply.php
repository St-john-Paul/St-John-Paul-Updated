...
<div id="spinner" class="show position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="both " style="border-top: 5px solid orange; background-color: rgb(255, 255, 255);">
        ...
        <!-- Navbar Start -->
    <nav class="navbar navbar-expand-md navbar-light shadow sticky-top p-0">
       
        <!--nav-->
        <center>
         <ul class="nav nav-pills" style="width: 1250px; height: 50px; background-color:rgb(248, 215, 155); justify-content: center;">
             <li class="nav-item">
               <a class="nav-link " aria-current="page" href="./index.php" style="font-weight: bolder; color:whitesmoke;  border: 1px solid whitesmoke; border-radius: 10px; margin-left: 5px; background-color: rgb(111, 111, 242);">Home</a>
             </li>
             <li class="nav-item">
                 <a class="nav-link " aria-current="page" href="./about.php" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; background-color: rgb(111, 111, 242); border-radius: 10px; margin-left: 5px;">About</a>
               </li>
             ...
             <li class="nav-item dropdown">
                 <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false" style="font-weight: bolder; color:whitesmoke; background-color: darkred; border: 1px solid whitesmoke;border-radius: 10px; margin-left: 5px;">More</a>
                 <ul class="dropdown-menu">
                   <li><a class="dropdown-item" href="./Fees.php" style="font-weight: bolder; background-color:  rgb(111, 111, 242);">Fees</a></li>
                   ...
                   <li><a class="dropdown-item active" href="./cv.php" style="font-weight: bolder;">CV's</a></li>
                   <li><a class="dropdown-item" href="./Other _requirements.php" style="font-weight: bolder;">Requirements</a></li>
               ...
               <li class="nav-item">
                 <a class="nav-link " aria-current="page" href="./team.php" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; background-color: rgb(111, 111, 242);  border-radius: 10px; margin-left: 5px;">Team</a>
               </li>
               <li class="nav-item">
                 <a class="nav-link " aria-current="page" href="./contact.php" style="font-weight: bolder; color:whitesmoke; border: 1px solid whitesmoke; background-color: rgb(111, 111, 242); border-radius: 10px; margin-left: 5px;">Contact</a>
               </li>
               <li class="nav-item dropdown">
    ...
    <div class="col-lg-10 text-center" style=" width: 1250px; background-color: darkred; margin-left: 1px;  margin-top: 0px; ">
        <h1 class="display-3 text-white animated slideInDown">Apply</h1>
    </div>
    <br>
    <!-- Header End -->
<br>
    <center><P><b><h2 style="color: orange;">  How to Apply</h2></b></p></center>
        ...
        <div class="wrap">
            <div class="paper">
              <h1>
                To apply for admission, please follow these steps:
                    ...
                    <p>Visit our website or school for more information.</p>
                    <p>Fill out the application form with accurate details.</p>
                    <p>Submit the completed form along with the required documents to the school office.</p>
                    <p>Contact us at 0784824441 |  0777609907 for any inquiries.</p>
            </div>
          </div>
          <br>
          ...
          <div class="arrow-container">
            <a href="./Fees.php" class="arrow back">
              &#8592; <!-- Left Arrow -->
            </a>
            <a href="./Other _requirements.php" class="arrow next">
              &#8594; <!-- Right Arrow -->
